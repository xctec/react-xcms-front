...
// 注意：glob 模式相对本文件（src/router），指向 src/views。映射 key 形如
 ...
 */
export function resolveFullPath(parentPath: string | undefined, routePath?: string): string | undefined {
...
export const STATIC_MENU: MenuTreeVO[] = [
  {
 ...
 */
export function buildMenuTree(dynamic: MenuTreeVO[]): AppMenuNode[] {
